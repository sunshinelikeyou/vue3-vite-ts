        ...
        if (multiple) {
            ...
            if (filterable) {
                ...
                body = (h("div", { ref: "singleElRef", class: `${clsPrefix}-base-selection-label`, tabindex: this.disabled ? undefined : 0 },
                    this.label !== undefined ? (h("div", { class: `${clsPrefix}-base-selection-label__input`, title: getTitleAttribute(this.label), key: "input" }, this.label)) : (h("div", { class: `${clsPrefix}-base-selection-placeholder`, key: "placeholder" }, this.placeholder)),
                    suffix));
            }
        }
