...
export default defineComponent({
    ...
    render() {
        const { dotPlacement, mergedClsPrefix, current, lengthRef, $slots: { default: defaultSlot } } = this;
        ...
        return (h("div", { class: [
            ...
            h("div", { class: `${mergedClsPrefix}-carousel__dots`, role: "tablist" }, indexMap(length, (i) => {
                ...
                return (h("div", { "aria-selected": selected, role: "button", tabindex: "0", class: [
                    ...
                    ], onClick: () => this.setCurrent(i + 1), onMouseenter: () => this.handleMouseenter(i + 1), onKeydown: (e) => this.handleKeydown(e, i + 1) }));
            }))));
    }
});
